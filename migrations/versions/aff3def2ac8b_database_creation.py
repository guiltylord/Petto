...
Revision ID: aff3def2ac8b
Revises: 35294c4552fd
Create Date: 2024-04-15 00:37:53.056865
...
revision: str = 'aff3def2ac8b'
down_revision: Union[str, None] = '35294c4552fd'
...
def upgrade() -> None:
    ...
    sa.Column('role_is', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['role_is'], ['roles.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
